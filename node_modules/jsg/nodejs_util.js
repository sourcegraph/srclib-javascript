...
exports.addPackageInfo = function(target) {
  ...
  var isOwnCoreModules = target.module.indexOf("node_core_modules") != -1; // these should not be associated with the jsg npm package
  if (!packageInfoCache.hasOwnProperty(cacheKey) && !isOwnCoreModules) {
